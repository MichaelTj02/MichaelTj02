...
**[Helmet and License Plate Recognition System](https://github.com/MichaelTj02/Helmet-and-License-Plate-Recognition-System)**
Computer vision system built with YOLO, Python, and OpenCV that detects helmet compliance and conditionally captures license plates only for violations. Model is trained on a cleaned, augmented dataset with visual performance evaluation via Matplotlib.
...
**[Spirit Mæs](https://github.com/DarianSawali/Spirit-Maes-Game)**
2.5D Unity platformer featuring a character possession and switching system with distinct per-character abilities, built in C# with OOP design and interaction logic driven by colliders, triggers, and animation state machines.
